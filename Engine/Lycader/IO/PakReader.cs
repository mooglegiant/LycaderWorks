...
namespace LycaderWorksEngine.IO
{
    static public class PakReader
    {
        ...
        public static void OpenPak(string filePath)
        {
            // File exists ??
        ...
        static public void ClosePak()
        {
            Data.Clear();
        }

        static public bool SavePak(string filePath)
        {
            // Return value
            bool retval = false;
        ...
        static public void AddResource(string filePath)
        {
        ...
        static public void RemoveResource(string fileName)
        {
            if (Data.ContainsKey(fileName))
            {
        ...
        static internal bool ZipResource(ZipOutputStream stream, string resourcename, byte[] data)
        {
            // Bad args
